...
int main()
{
    ...
    cout<<endl;
    cout<<"--- There is/are "<<total_error<<" line(s) having an error ---"<<endl;
...
for (MapIterator iter =SYMTAB.begin(); iter != SYMTAB.end(); iter++)
{
    ...
    cout<<"--- U n s u c c e s s f u l  A s s e m b l y ---"<<endl;
...
void ReadInput()
{
    ...
    if(FILE==NULL)
    {
        cout<<"srcfile.txt not found, please place in program's directory!"<<endl;
        return;
    }
